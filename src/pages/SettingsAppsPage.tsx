...
export const SettingsAppsPage = () => {
	...
	useEffect(() => {
		if (!isAdmin) return
		void Promise.all([operationsService.jellyfinConfig(), operationsService.githubConfig()])
			.then(([jellyfin, github]) => { setJellyfinConfig(jellyfin); setGitHubConfig(github) })
